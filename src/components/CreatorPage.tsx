...
const benefits = [
  ...
  },
  {
    icon: DollarSign,
    title: 'Прямые заявки',
    description: 'Клиенты оставляют заявки, а оплату вы получаете напрямую удобным для вас способом'
  },
  {
    icon: Users,
...
const earningWays = [
  {
    ...
    description: 'Размещайте авторские туры и получайте оплату напрямую после подтверждения заявки',
    percentage: 'Заявки'
  },
  {
    icon: Briefcase,
...
const inspirationSteps = [
  ...
  },
  {
    ...
    description: 'Клиенты оставляют заявки, а вы подтверждаете места и получаете оплату напрямую'
  }
];
            ...
            >
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  TripGen — это платформа для гидов и туроператоров, где вы можете разместить туры, получать прямые заявки и принимать оплату от клиентов напрямую.
                </p>
                <motion.button
