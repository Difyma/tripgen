            ...
            >
              ...
              <div className="mt-6 flow-root">
                ...
                <div className="border-t border-gray-200 py-6 space-y-4">
                  <button className="w-full rounded-lg px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50">
                    Войти
                  </button>
                  <button className="w-full rounded-full bg-black px-3 py-2 text-base font-medium text-white shadow-sm hover:bg-gray-900">
                    Стать создателем
                  </button>
                </div>
              </div>
