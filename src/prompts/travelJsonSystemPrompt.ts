...
- В itinerary каждый день должен отличаться по содержанию: не повторяй одинаковые блоки утро/день/вечер и не дублируй одни и те же активности дословно из дня в день.
